...
public class Columns{
    ...
    private final static String url = "https://test.cgateway-portal.verifone.com/"; //BaseTest.envConfig.getWebUrl();
...
//		}
	...
	driver.get("https://test.cgateway-portal.verifone.com/");
...
//		Thread.sleep(2000);
		...
		builder.sendKeys(usern, "vfiqadevadmin@getnada.com").build().perform();
...
//		Thread.sleep(2000);
		...
		driver.switchTo().defaultContent();
//		driver.findElement(By.id("btnPrimaryLogin")).click();
		Thread.sleep(2000);
