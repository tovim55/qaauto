...
//        starTestLog("Check: " + TestName + " Row: " + RowNumber, "CG - PortalSite, check mandatory fields");
//        if (firstTime) {
//            openChromeBrowser();
//            loginAndCheck();
//            appNavigate();
...
//                                        String ThrottlingMaxRequestCount, String Error, String TestName, String RowNumber) {
//        starTestLog("Check: " + TestName + " Row: " + RowNumber, "CG - PortalSite, check type validation");
//        if (firstTime) {
//            openChromeBrowser();
//            loginAndCheck();
//            appNavigate();
...
//    }
    ...
    public void checkErrorHandleDDT(String applicationsID, String Version, String Name, String Status, String Access,
                                       String ThrottlingMaxRequestCount, String Error, String TestName, String RowNumber) {
        starTestLog("Check: " + TestName + " Row: " + RowNumber, "CG - PortalSite, check error handling and max/min length");
        if (firstTime) {
            openChromeBrowser();
            loginAndCheck();
            appNavigate();
