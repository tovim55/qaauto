...
public class CreateMerchantIL extends BaseApi {

    public CreateMerchantIL(String accessToken, String correlationId) throws IOException {
        super();
...
//        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss");
        ...
        JsonObject requestObj = readJsonFile(baseApiPath + "createMerchant\\create_merchantIL.json");
