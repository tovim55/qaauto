...
public class CreateMerchantPR extends BaseApi {

    public CreateMerchantPR(String accessToken, String correlationId) throws IOException {
        super();
...
//        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss");
        ...
        JsonObject requestObj = readJsonFile(baseApiPath + "createMerchant\\create_merchantMX.json");
