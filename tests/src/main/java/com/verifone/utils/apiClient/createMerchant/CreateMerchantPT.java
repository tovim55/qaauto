...
public class CreateMerchantPT extends BaseApi {

    public CreateMerchantPT(String accessToken, String correlationId) throws IOException {
        super();
    ...
    public String createMerchantPT(String eoAdminId) throws IOException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
//        Date date = new Date();
//        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss");
        String id = UUID.randomUUID().toString();

        JsonObject requestObj = readJsonFile(baseApiPath + "createMerchant\\create_merchantPT.json");
